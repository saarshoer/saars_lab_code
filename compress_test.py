...
output_dir = '/net/mraid08/export/jasmine/CountsS_compressed'#_new'
...
still_running = []
skip_species = not_updated + still_running
...
# sethandlers()
#
# with qp(jobname='test_comp') as q:
#
#     q.startpermanentrun()
#     tkttores = {}
...
for input_file in glob.glob(os.path.join(input_dir, file_name)):
    ...
    if species not in skip_species:
        input_keys = get_keys(input_file)
        output_keys = get_keys(output_file)
