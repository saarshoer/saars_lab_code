...
class P:
    ...
    # with pd.HDFStore('/net/mraid08/export/genie/LabData/Analyses/saarsh/20230129_113349/mb_dists.h5', 'r') as hdf:
...
if __name__ == '__main__':
    ...
    # import glob
    # files = glob.glob('/net/mraid08/export/genie/LabData/Analyses/saarsh/20221221_131315/*.h5')
