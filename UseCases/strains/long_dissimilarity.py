...
class P:
    # data
    study_ids = ['PNP1', 'Longitudinal', '10K']
    body_site = 'Gut'

    # dfs_dir = f'/net/mraid20/ifs/wisdom/segal_lab/jafar/Microbiome/Analyses/saar/strains/Longitudinal/data_frames'
    ...
    work_dir_suffix = 'Longitudinal_diss'
    ...
    samples_set = GutMBLoader().get_data('segal_species', study_ids=study_ids).df_metadata
    samples_set = samples_set[samples_set['RegistrationCode'].isin(['72', '10K_2869902522'])].index
