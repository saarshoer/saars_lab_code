...
clump_file = os.path.join(base_path, 'clumping7', 'mb_gwas_{X}_{Y}.pkl')
...
if __name__ == '__main__':
    ...
    with qp(jobname='RWKNclumping', _tryrerun=True, _mem_def='5G') as q:
        q.startpermanentrun()
        tkttores = {}
        ...
        significant_df.to_hdf(sig_file.replace('.h5', '_clumping7.h5'), key='snps')
