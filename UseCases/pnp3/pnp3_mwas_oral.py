...
class P:
    ...
    #     '/net/mraid20/export/genie/LabData/Analyses/saarsh/PNP3_mwas_oral_0months/done_species.csv', index_col=0)
...
if __name__ == '__main__':
    ...
    work_dir = '/net/mraid20/export/genie/LabData/Analyses/saarsh/PNP3_mwas_oral_change_R3_constant'
