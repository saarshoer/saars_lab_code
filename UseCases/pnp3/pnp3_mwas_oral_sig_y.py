...
class P:
    ...
    #     '/net/mraid08/export/genie/LabData/Analyses/saarsh/PNP3_mwas_oral_small/done_species.csv', index_col=0)
    ...
    # y
    y_gen_f = lambda subjects_df: gen_f(subjects_df, os.path.join(df_dir, f'oral_mwas_input_sig_y.df'))
...
if __name__ == '__main__':
    ...
    work_dir = '/net/mraid08/export/genie/LabData/Analyses/saarsh/PNP3_mwas_oral_small'
    ...
    # P.y.to_pickle(os.path.join(df_dir, f'oral_mwas_input_sig_y.df'))
    # P.max_pval_to_report = 1
    # P.work_dir_suffix = f'{P.work_dir_suffix}_all_pvals_sig_y'
    # d = MWAS(P)
    # work_dir = d.gen_mwas()
    # print(work_dir)
